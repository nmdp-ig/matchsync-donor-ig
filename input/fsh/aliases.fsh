// NMDPDonorPatient IG — Shared Aliases
// See AGNIS-on-FHIR System URIs (Confluence page 137761765)
...
Alias: $nmdp-specimen-type = http://terminology.nmdp.org/codesystem/specimen-type
