...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.nmdp.org/ig/donor-patient/StructureDefinition/cbu-status']) &lt;= 1">extension with URL = 'http://fhir.nmdp.org/ig/donor-patient/StructureDefinition/cbu-status': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
